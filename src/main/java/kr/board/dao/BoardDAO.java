...
public class BoardDAO {
	...
	public BoardVO getBoard(int board_num)throws Exception{
		...
		try {
			//커넥션풀로부터 커넥션을 할당
			conn = DBUtil.getConnection();
			//SQL문 작성 (주의)회원탈퇴하면 zmember_detail의 레코드가 존재하지 않기 때문에 외부 조인을 사용해서 데이터 누락 방지(LEFT OUTER JOIN)
